...
| `operatingMargin` | `0.50` | AI INFERENCE — below the OBSERVED FY2026 level (60.39%) but well above the ten-year median (30.52%), reflecting some give-back of recent margin expansion under competitive and pricing pressure. |
...
| `operatingMargin` | `0.60` | AI INFERENCE — holds near the OBSERVED FY2026 level (60.39%). |
